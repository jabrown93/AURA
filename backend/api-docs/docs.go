        ...
        "/api/auth/oidc/callback": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Opaque state issued when sign-in started",
                        "name": "state",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "302": {
                        "description": "Redirect to the app on success, or to /login with an error code"
                    }
                }
            }
        },
    ...
    "definitions": {
        ...
        "config.Config_Auth": {
            ...
            "properties": {
                ...
                "oidc": {
                    "description": "Single sign-on via an OpenID Connect provider.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/config.Config_OIDC"
                        }
                    ]
                },
                "password": {
        ...
        "config.Config_Kometa": {
            ...
            "properties": {
                ...
                "library_asset_folders": {
                    "description": "Optional per-library subfolder (relative to AssetDirectory) keyed by Plex library title. When set, a library's assets are written to \u003cAssetDirectory\u003e/\u003csubfolder\u003e/\u003citem\u003e/... instead of directly under AssetDirectory. Must match the per-library asset_directory configured in Kometa itself. A library with no entry keeps writing flat to AssetDirectory.",
                    "type": "object",
                    "additionalProperties": {
                        "type": "string"
                    }
                },
                "sonarr_radarr_fallback": {
                    "description": "When a media-server lookup fails (e.g. Plex returns a 404) but the item exists in Sonarr/Radarr, still write the downloaded images into the Kometa asset directory, deriving the asset folder name from the Sonarr/Radarr path. Requires Enabled. Plex exclusive feature.",
                    "type": "boolean"
                }
            }
        },
        ...
        "config.Config_OIDC": {
            ...
            "properties": {
                "allowed_emails": {
                    "description": "Email addresses permitted to sign in.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "allowed_groups": {
                    "description": "Groups permitted to sign in.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "allowed_subjects": {
                    "description": "Subject identifiers permitted to sign in.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "button_label": {
                    "description": "Label for the sign-in button. Defaults to \"Sign in with SSO\".",
                    "type": "string"
                },
                "client_id": {
                ...
                "client_secret": {
                    "description": "Client secret registered with the provider.",
                    "type": "string"
                },
                "enabled": {
                    "description": "Whether to offer OIDC sign-in.",
                    "type": "boolean"
                },
                "groups_claim": {
                    "description": "Authorization. When every list is empty, any user the provider authenticates is\nallowed in and access is governed by the provider's own application policy.\nWhen any list is set, the user must match at least one entry.",
                    "type": "string"
                },
                "issuer_url": {
                    "description": "Provider issuer, used for discovery (e.g. https://auth.example.com/application/o/aura/).",
                    "type": "string"
                },
                "redirect_url": {
                    "description": "Callback URL registered with the provider. Must be absolute: it is never derived from\nthe request, since the Host header is attacker controlled.",
                    "type": "string"
                },
                "rp_initiated_logout": {
                    "description": "Whether logout should also end the session at the provider.",
                    "type": "boolean"
                },
                "scopes": {
                    "description": "Scopes to request. \"openid\" is always included.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "routes_auth.authMethodsResponse": {
            ...
            "properties": {
                ...
                "oidc_button_label": {
                    "description": "Label for the SSO button",
                    "type": "string"
                },
                "oidc_enabled": {
                    "description": "Whether the SSO button should be shown",
                    "type": "boolean"
                },
                "password_enabled": {
        ...
        "routes_auth.logoutResponse": {
            ...
            "properties": {
                "end_session_url": {
                    "description": "EndSessionURL is set when the provider should also be told to end its session.\nThe UI navigates there after logging out locally.",
                    "type": "string"
                },
                "logged_out": {
                    "type": "boolean"
